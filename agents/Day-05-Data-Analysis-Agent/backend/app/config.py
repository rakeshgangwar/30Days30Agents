...
class Settings(BaseSettings):
    ...
    # Agent Settings
    AGENT_MAX_ITERATIONS: int = 50  # Increased from 25 to allow more complex queries
    AGENT_MAX_EXECUTION_TIME: int = 120  # Increased from 60 to allow more time for execution
