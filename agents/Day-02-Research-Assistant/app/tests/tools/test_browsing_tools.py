...
class TestWebBrowsingTool(unittest.TestCase):
    ...
    def test_error_recovery(self):
        ...
        self.browsing_tool._fetch_with_playwright.reset_mock()
        self.browsing_tool._fetch_with_requests.reset_mock()
        
        # With fallback disabled
        self.browsing_tool.enable_fallback = False
        
        # Should raise the exception
        with self.assertRaises(Exception):
            self.browsing_tool.fetch_content(url)
        
        # Verify playwright was tried but not requests
        self.browsing_tool._fetch_with_playwright.assert_called_once_with(url)
        self.browsing_tool._fetch_with_requests.assert_not_called()
